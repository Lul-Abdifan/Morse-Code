...
- [ ] **Add Function To Decode Text To Morse Code**
...
Feel free to check the [issues page](https://github.com/Lul-Abdifan/Morse-Code/issues).
...
This project is [MIT](https://github.com/Lul-Abdifan/Morse-Code/blob/morse_code-branch/MIT.md) licensed.
